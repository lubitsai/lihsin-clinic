/* ============================================================
   ...
   版本：lhpc-pwa-v7（2026-09-26；v6＝2026-09-25、v5＝2026-09-24、v4＝2026-09-16、v3＝2026-09-10、v2＝2026-09-07、v1＝2026-07-04）
   ------------------------------------------------------------
   快取策略（保守設計，內容更新永遠優先）：
   ...
   ⚠️ 2026-09-26 v7：同網址覆蓋 /docs/lihsin-clinic-intro-2026.pdf（疫苗停打句改
      「最後一診結束前」），PDF 同屬第 2 條快取範圍，依上列判準 bump。
   移除方式（kill switch）：見 docs/PWA部署包說明 §7。
   ============================================================ */
'use strict';

const VERSION = 'lhpc-pwa-v7';
const PRECACHE = [
  '/offline.html',
  '/tailwind.css',
