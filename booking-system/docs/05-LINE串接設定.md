...
| 線上預約成立 | 若該病歷是這次新建的，或**生日與手機都與既有病歷相符**，即自動綁定病人 ↔ LINE |
| 手機與病歷紀錄不符 | 預約照樣成立，但**不綁定**：完成頁明講通知與線上查詢尚未開通，請致電或到櫃檯核對 |
| 一個 LINE 帳號多位家庭成員 | 可於「查詢我的預約」頁自行綁定（證件＋生日＋手機三者相符）／解除，各成員限制分開計算 |
| LINE 登入失敗或民眾取消授權 | 導回查詢頁；**沒有替代身分**，改走電話或現場掛號 |
| 民眾封鎖官方帳號 | webhook 標記為非好友，之後不再排入通知（櫃檯需電話聯絡） |
| 通知內容 | 一律不含完整證件號與病情資訊 |

> **為什麼綁定要卡「生日＋手機都相符」**：綁定等於這個 LINE 帳號從此看得到該病人的
> 所有預約紀錄。若只要填得出證件號就綁，任何知道他人證件號的人都能讀到其看診紀錄。
> 這條線與「查詢身分驗證」用的是同一把尺（`verifyPatientIdentity`）。
