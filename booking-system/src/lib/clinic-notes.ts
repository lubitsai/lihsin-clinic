...
export const CLINIC_TYPE_NOTES: Record<string, ClinicNote> = {
  GENERAL: {
    title: "要打預防針的話",
    items: [
      "每日最後一診結束前 1 小時停止施打疫苗（清點申報作業）。不論預約或現場，都請在週一至週五 20:30 前、週六 17:00 前、週日 20:00 前到院。",
 ...
 *
 * 擺放位置經院長 2026-09-26 核可（docs/08 §六之二 6b-1～6b-3）。
 *
 ...
 *
 * 擺放位置經院長 2026-09-26 核可（docs/08 §六之二 6b-4、6b-5）。
 *
