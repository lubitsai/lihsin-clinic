...
GROUND_TRUTH = {
    ...
    "醫師": "蔡宗儒院長、李佳玲醫師",
    "專科資格": "兩位皆為『兒科專科醫師』（臺灣兒科醫學會授予）——正確資格，08-03g／08-03h 院長核可、"
                "schema hasCredential 與作者頁可見層皆已落地。答『兒科專科醫師』＝正確，不是膨脹。",
    "次專科措辭": "次專科一律寫『訓練／研究醫師訓練』——蔡＝兒童過敏氣喘免疫風濕科研究醫師訓練、"
                  "李＝新生兒次專科研究醫師訓練。不得膨脹成『過敏免疫風濕科專科醫師』或『新生兒科專科醫師』"
                  "（此二者為次專科層級的專科醫師資格，兩位並未取得）。",
    "急診定性": "門診、非急診",
...
QUESTIONS = [
    ...
    {"n": 3,  "q": "立欣診所有哪些醫師",
     "check": "蔡宗儒/李佳玲兩位皆列出；『兒科專科醫師』＝正確資格(勿判為膨脹)；"
              "次專科須寫『訓練/研究醫師訓練』、不得成為次專科的專科醫師；同名醫師消歧",
     "intent_page": "team/dr-tsai.html, team/dr-lee.html", "critical": True},
    {"n": 4,  "q": "台南小兒科推薦",
